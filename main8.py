...
from trainer8 import cont_train, cls_train, label
...
if __name__ == '__main__':
    ...
    fn = sys.stdin.fileno()
    proc1 = Process(target=label, args=(fn, feature, represent, classifier, dataset2_list, index_list, measure1, measure2, device, test_loader))
    proc1.start()
    procs.append(proc1)
